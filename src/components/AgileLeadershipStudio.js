          ...
          <div className="col-lg-8">
            <div className="blog-one__single">
              ...
              <div className="blog-one__content text-center">
                ...
                tryScrum’s vision is to Humanize Organizations. We believe through leaders we can help people unleash the power of intelligence of oneself. The “Agile Leadership Studio” is intended to instil leadership skills. Leadership require learning, convincing, nurturing and bringing in Change. That doesn’t happen overnight, but its a journey. Come Role Play.
          ...
          <div className="col-lg-4">
            <div className="pricing-one__single">
              <div className="pricing-one__inner">
                ...
                <a href="https://www.meetup.com/agileleadershipstudio/" target="__blank" className="thm-btn pricing-one__btn">
                  Click Here
                </a>
