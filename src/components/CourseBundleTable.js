  ...
  console.log("Course Information In Bundle", msg.acfcoursePage);
    ...
    return (
      <div className="table-responsive h-25">
        <table className="table borderless table-hover" style={{height: "900px"}}>
          <thead
            style={{
          ...
          <tbody style={{fontWeight:"bolder"}}>
            ...
            {!msg.acfcoursePage.bundle.category ? (
                          ...
                          <tr key={msg.acfcoursePage.bundle.category}>
                  ...
                  {!msg.acfcoursePage.bundle2.category ? (
                          ...
                          <tr key={msg.acfcoursePage.bundle2.category}>
...
{!msg.acfcoursePage.bundle3.category ? (
                          ...
                          <tr key={msg.acfcoursePage.bundle3.category}>
...
{!msg.acfcoursePage.bundle4.category ? (
                          ...
                          <tr key={msg.acfcoursePage.bundle4.category}>
...
{!msg.acfcoursePage.bundle5.category ? (
                          ...
                          <tr key={msg.acfcoursePage.bundle5.category}>
...
{!msg.acfcoursePage.bundle6.category ? (
                          ...
                          <tr key={msg.acfcoursePage.bundle6.category}>
...
{!msg.acfcoursePage.bundle7.category ? (
                          ...
                          <tr key={msg.acfcoursePage.bundle7.category}>
...
{!msg.acfcoursePage.bundle8.category ? (
                          ...
                          <tr key={msg.acfcoursePage.bundle8.category}>
...
{!msg.acfcoursePage.bundle9.category ? (
                          ...
                          <tr key={msg.acfcoursePage.bundle9.category}>
...
{!msg.acfcoursePage.bundle10.category ? (
                          ...
                          <tr key={msg.acfcoursePage.bundle10.category}>
...
{!msg.acfcoursePage.bundle11.category ? (
                          ...
                          <tr key={msg.acfcoursePage.bundle11.category}>
