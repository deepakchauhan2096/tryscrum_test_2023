  ...
  renderMessages() {
    ...
    return (
      ...
      <>
        ...
        {filtered == 0 ? "" : <center className="desktopdisplay">
        ...
        <div className="desktopdisplay">
          {this.state.currenttableview.length >= 1 ?
            <Carousel itemsToShow={3} itemPosition={consts.START} showEmptySlots>
                ...
                <div className="card-container"  >
                  <div className="card-main">
                    ...
                    <ul className="list-group list-group-flush" >
                      ...
                      <li style={{ fontWeight: "200" }} className="list-group-item card-list"><i class="fa fa-user"></i>&nbsp; 
                          <a
                          
                          href={
                            filtered.trainer.charAt(0)+filtered.trainer.charAt(1) == "Ar" 
                            ? "/arunvignesh/" :
                            filtered.trainer.charAt(0)+filtered.trainer.charAt(1) == "Ve"
                            ? "/venkatesh/" :
                            filtered.trainer.charAt(0)+filtered.trainer.charAt(1) == "Ki"
                            ? "/kiran/" :
                            filtered.trainer.charAt(0)+filtered.trainer.charAt(1) == "Mo"
                            ? "/umer" :
                            "#"
                          }  target="_blank"
                      ...
                      </strike> &nbsp;{filtered.salePrice} &nbsp; <span data-title="The price listed is only for Indian Markets. Please click the enroll button to know the prices for foreign markets."><i class="fa fa-info-circle info-detail"></i></span></p>
                    </ul>
                    <center>
              ...
              <>
                {filtered.length == 0 ? " " : <Carousel itemsToShow={3} itemPosition={consts.START} showEmptySlots>
                    ...
                    <div className="card-container">
                      ...
                      <div class="card-main">
                        ...
                        <ul className="list-group list-group-flush"  >
                          ...
                          <p style={{ fontWeight: "200" }} className="list-group-item card-list"><i class="fa fa-tag"></i>&nbsp; <strike>
                            {filtered.regularPrice}
                          </strike> &nbsp;{filtered.salePrice} &nbsp; <span data-title="The price listed is only for Indian Markets. Please click the enroll button to know the prices for foreign markets."><i className="fa fa-info-circle info-detail"></i></span></p>
                        </ul>
                        <center>
                          {filtered.url[0] == "E" || filtered.url[0] == "e" ? (
                            <td>
        ...
        {
          filtered == 0 ? "" : <center className="tabletdisplay">
            <div className="centered">
              <select
                className="filter-button-tag"
                onChange={(event) => HandleCountry(event, 3)}
        ...
        <div className="tabletdisplay">
          {this.state.currenttableview.length >= 1 ?
            <Carousel itemsToShow={2} itemPosition={consts.START} showEmptySlots>
              {this.state.currenttableview.map((filtered) => (
                <div className="card-container"  >
                  <div className="card-main">
                    <div className="card-body">
            ...
            </Carousel> : <div>{this.state.currenttableview.length == 0 ? <>
              <div id="close" className="modal-overlay">
                {countryfound ?
                  <div className="popupbox">
                    <a className="close" href="#close" ><button
                    ...
                    >&times;</button></a>
                    <div className="content">
                      <h2>Sorry, no courses found! Please contact our support to schedule one</h2>
                    </div>
                  </div> :
                  <div className="popupbox">
                    <a className="close" href="#close" ><button
              ...
              <>
                {countryfound ? "" : <Carousel itemsToShow={2} itemPosition={consts.START} showEmptySlots>
                  {filtered.map((filtered) => (
                    <div className="card-container">
        ...
        {
          filtered == 0 ? "" : <> <center className="mobiledisplay">
            <div className="centered">
              <select
                className="filter-button-tag"
                onChange={(event) => HandleCountry(event, 3)}
        ...
        <div className="mobiledisplay">
          {this.state.currenttableview.length >= 1 ?
            <Carousel itemsToShow={1} showArrows={false} disableArrowsOnEnd={true} enableAutoPlay={false} autoPlaySpeed={2300} itemPosition={consts.START} showEmptySlots>
              {this.state.currenttableview.map((filtered) => (
                <div className="card-container"  >
            ...
            : this.state.currenttableview.length == 0 ?
              ...
              :
              <>
                {filtered.length === 0 ? "" : <Carousel itemsToShow={1} showArrows={false} disableArrowsOnEnd={true} enableAutoPlay={false} autoPlaySpeed={2300} itemPosition={consts.START} showEmptySlots>
                  {filtered.map((filtered) => (
                    <div className="card-container">
                      <div>
                        <div className="card-main">
