...
const ModalICPCAT = () => {
  ...
  const submitHandler = async (e) => {
    ...
    if (state.email && state.name && checked) {
      ...
      setloader('loading');
      const url =
        "https://tryscrumlive.vervebot.io//wp-json/contact-form-7/v1/contact-forms/6723/feedback";
      ...
      if (typeof res.data.message !== undefined) {
        if (checked) {
          ...
          // window.open("https://tryscrumtest.netlify.app/icp-cat.pdf","_blank")
          // window.open(
          //   downloadFile,
          ...
          <div className='modal_box'>
            <form>
              ...
              {loader == 'loading' ? <button
                ...
                disabled
              >Download Brochure<div class="loader"></div></button> : <button
                type="submit"
                onClick={submitHandler}
                className="btn btn-primary ml-0"
