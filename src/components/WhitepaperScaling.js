            ...
            <div className="blog-one__single">
              ...
              <div className="blog-one__content text-center">
                ...
                <p className="blog-one__text">
                  In 2016, a leading security products company adopted Scrum to
                  support teams working in complex product development, in order
                  to make the organization more adaptive and able to react
                  faster to change. It began with one Scrum Team of IT
                  developers focused on mobile applications. Shortly thereafter,
                  more Scrum Teams were formed to revamp its existing platform
                  in a new contemporary stack, composed of new hires focusing on
                  API development, mobile app development and integration
                  services. There was one Product Owner who began struggling
                  with managing multiple priorities across these teams.
                </p>
                {/* <p className="blog-one__text">
...
export default WhitepaperScaling;