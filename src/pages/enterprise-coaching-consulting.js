...
// import svg_banner from "../assets/images/management-website-01.png"
...
const Coaching = () => {
  ...
  return (
    <Layout pageTitle="Enterprise Coaching & Consulting" metaDesc="Spinning up a single Scrum team is a challenge. Building an agile organization is a journey. We work with you to create a plan and execute it to build and sustain an agile organization." pageName="enterprise_coaching_consulting" >
        ...
        <div className="row align-items-center">
          <div className="col">
            ...
            <p className="lead" style={{ color: "black" }}>
              No matter what the future brings, building a capable and resilient organisation is the need of the
              hour. At tryScrum, our mission is to help organisations become capable and resilient. In this
              paper, we will share our experience of some of the tenets that helped organisations we worked with.
            ...
            <p className="lead" style={{ color: "black" }}>
              <ol>
                <li>
                  ...
                  Sykes T. (2019, December 2).
                </li>
                <li>
                  Why you need to learn to adapt. Retrieved December 9, 2019, from <a href="https://www.entrepreneur.com/article/343047">https://www.entrepreneur.com/article/343047</a>
                </li>
              </ol>
      ...
      <br />
      <div className="comtainer" style={{display:"flex",margin:"0 auto",justifyContent:"center"}}>
            <ModalWhitepaper />
      </div>
      ...
      <div className="container g-0">
        <h1 style={{ color: "#012237", fontWeight: "bold", textAlign: "center" }}>
